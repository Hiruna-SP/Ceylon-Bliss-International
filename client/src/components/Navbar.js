    ...
    return (
        <nav className="bg-white shadow-md px-6 py-4 flex items-center justify-between flex-wrap">
            ...
            <div className="flex items-center space-x-6">
                ...
                <div className="hidden md:flex items-center bg-gray-100 border border-black rounded-full px-4 py-2 shadow-md focus-within:ring-2 focus-within:ring-orange-500 transition-all duration-300">
                    <input
                    type="text"
                    placeholder="Search spices..."
                    className="bg-transparent outline-none text-sm w-40 md:w-60 px-2 placeholder-gray-500"
                    />
                    <button className="text-orange-500 hover:text-orange-600 transition-all duration-300">
